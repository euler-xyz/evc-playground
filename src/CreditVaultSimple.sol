...
contract CreditVaultSimple is CreditVaultBase, ERC4626 {
    ...
    ) CreditVaultBase(_cvc) ERC4626(_asset, _name, _symbol) {
    ...
    returns (bool) {
        address msgSender = CVCAuthenticate(msg.sender, false);
    ...
    function transferFrom(address from, address to, uint256 amount) public override nonReentrant
    nonReentrant
    returns (bool) {
    ...
    function deposit(uint256 assets, address receiver) public override nonReentrant
    ...
    function mint(uint256 shares, address receiver) public override nonReentrant
    ...
    function withdraw(uint256 assets, address receiver, address owner) public override nonReentrant
    returns (uint256 shares) {
    ...
    function redeem(uint256 shares, address receiver, address owner) public override nonReentrant
    returns (uint256 assets) {
        vaultStatusSnapshot();
        address msgSender = CVCAuthenticate(msg.sender, false);
